...
# ---------------- 1. 读取数据（已写死完整路径，适配你的文件夹） ----------------
# 自动去除表头空格，避免读取错误
df = pd.read_csv(r"C:\Users\Cyjho\OneDrive\桌面\ACC102.track4.YONGJIN.CHEN24\pl_economic_data.csv")
df.columns = df.columns.str.strip()  # 处理表头的隐藏空格
